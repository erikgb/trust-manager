...
func (in *BundleTarget) DeepCopyInto(out *BundleTarget) {
	*out = *in
	in.BundleTargetSpec.DeepCopyInto(&out.BundleTargetSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BundleTargetSpec) DeepCopyInto(out *BundleTargetSpec) {
	*out = *in
	if in.ConfigMap != nil {
		in, out := &in.ConfigMap, &out.ConfigMap
		*out = new(KeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BundleTargetSpec.
func (in *BundleTargetSpec) DeepCopy() *BundleTargetSpec {
	if in == nil {
		return nil
	}
	out := new(BundleTargetSpec)
	in.DeepCopyInto(out)
	return out
}
